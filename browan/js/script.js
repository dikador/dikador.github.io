...
$(document).ready(function () {
   $(hb).mouseover(function () {
      ...
      $(hb).each(function (index, element) {
         ...
         if (hb[index].classList.contains('active-history') == false) {
...
//       $(this).removeClass('hsa');

//       $(this).addClass('active-history');

//       $(this).prev().addClass('hsa');
...
// let hsb = document.querySelectorAll('.history__block');

// let hs = document.querySelectorAll('.history-circle');


// for (let index = 0; index < hsb.length; index++) {
//    const element = hsb[index];
//    const element2 = hs[index];
