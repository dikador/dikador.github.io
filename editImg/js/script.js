...
const containerWidth = window.innerWidth - 11.2;
...
try {
   ...
   const shapes = [
      `<svg viewBox="-10 -10 180 180" fill="none" stroke="none" stroke-linecap="square" stroke-miterlimit="10"><path stroke="#ffffff" stroke-width="8" stroke-linecap="butt" d="m0 0l25.742783 0l0 0l38.614174 0l90.09974 0l0 52.74803l0 0l0 22.6063l0 15.070862l-90.09974 0l-61.5304 52.813744l22.916225 -52.813744l-25.742783 0l0 -15.070862l0 -22.6063l0 0z" fill-rule="evenodd"></path></svg>`,
...
$('#upload').click(function (e) {
   e.preventDefault();
   $('.drag-drop-input').trigger('click');
});

$("#font-family option").each(function (index, element) {
