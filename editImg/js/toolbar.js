...
(function () {
  ...
  var defaultButtons = [{
    ...
    name: 'upload',
    title: 'Upload image',
    icon: ` <div class="tab-img">
    <img src="img/upload.png" alt="photo">
    <img class="active" src="img/uploadActive.png" alt="photo">
</div>
Загрузить`
  }, {
    name: 'background',
  ...
  const defaultExtendedButtons = [{
    ...
    title: 'Download',
    icon: `<div class="tab-img">
    <img src="img/download.png" alt="file">
    <img class="active" src="img/downloadActive.png" alt="file">
    </div>
    Скачать`
  }]
